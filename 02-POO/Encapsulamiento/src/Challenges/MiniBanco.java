...
class Cliente{
    ...
    public int getNroCuentas() {return nroCuentas;}

    public void setNroCuentas(int nroCuentas) {this.nroCuentas = nroCuentas;}
    
    public String reporte(){return "\nDni: "+dni+"\nNombre: "+nombre+"\nDireccion: "+direccion;}
...
class Cuenta{
    ...
    public void deposito(double cant){saldo = saldo + cant;}
