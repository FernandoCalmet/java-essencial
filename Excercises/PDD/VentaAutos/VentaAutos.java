...
public class VentaAutos {
    ...
    public static void main(String[] args) {
        ...
        Venta venta2 = new VentaAutoUsado("Alfa Romeo 156 1.8 TS", 259000, 2000,
                "34.500 km. servo control, cambio antibloqueo, ventana electrica, sp.chassis, 17'alu, aire acondicionado, pestillos electricos remotos, descanso para cabecera, CD, aros de aluminio, llave y accesorios plenos.");
        ...
        /* CLIENTE #2 : JURIDICO */
        Cliente cliente2 = new ClienteJuridico("Helisa S.A.C", "Grau 343", "+51 73 919 232", "Eric Tordoya",
                "+47 900 13 260");
        registro.nuevoCliente(cliente2);
        /* VENTA DE CLIENTE #2 : AUTO USADO */
        Venta venta3 = new VentaAutoUsado("Toyota Corolla", 439000, 1986,
                "44.830 km.aut., sistema de aire acondicionado, asientos de cuero, airbag, servo control, 4 ventans electricas deslizantes, asiento ajustable, aro 16'alu, seguros de puerta a control remoto, frenos anti bloqueantes, mantenimiento gratis por un anio.");
