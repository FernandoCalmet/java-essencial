...
class Productos
{
    ...
    {        
        ConexionBD conexion = new ConexionBD();
        Statement declaracion = conexion.Conectar().createStatement();
        declaracion.executeUpdate("INSERT INTO productos (nombre, categoria) VALUES('"+pNombre+"', '"+pCategoria+"')");
    ...
    {        
        ConexionBD conexion = new ConexionBD();
        Statement declaracion = conexion.Conectar().createStatement();
        declaracion.executeUpdate("UPDATE productos SET nombre = '"+pNombre+"', categoria = '"+pCategoria+"' WHERE codigo = '"+pCodigo+"'");
