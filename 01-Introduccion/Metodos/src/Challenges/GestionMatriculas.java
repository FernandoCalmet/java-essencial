...
public class GestionMatriculas {
    ...
    public static void main(String[] args) {
        ...
        JOptionPane.showMessageDialog(null,"Bienvenido! Para iniciar el sistema de matriculas requiere que ingrese la cantidad de cursos de la carrera que va a gestionar.");
        ...
        do{
            ...
            case 2:
                if(capacidadCursos>0){
                    ...
                    JOptionPane.showMessageDialog(null, "Esta accion no esta permitida. Primero debe ingresar la cantidad de cursos.");
                }                    
                break;
            case 3:
                if(capacidadCursos>0){
        ...
        if(capacidadCursos==0){
            do{            
                capacidadCursos = Integer.parseInt(
                    JOptionPane.showInputDialog(
                        "Ingresar la cantidad de cursos que se van a poder registrar."
                    )
                );         
            }
    ...
    public static void reportarDatos(int nt,int capacidadCursos,String idCurso[],String nombreCurso[],int numeroCreditos[],int ciclo[],String idPreRequisito[]){  
    ...
    public static int agregarDatos(int nt,int capacidadCursos,String idCurso[],String nombreCurso[],int numeroCreditos[],int ciclo[],String idPreRequisito[]){
        if(nt<capacidadCursos){
            for(int i=0;i<1;i++){ 
                do{
                idCurso[i] = JOptionPane.showInputDialog("Ingresar el ID del Curso\n(Longitud de 7 caracteres obligatorio!)");
                }
                ...
                do{
                    numeroCreditos[i] = Integer.parseInt(JOptionPane.showInputDialog("Ingresar la cantidad de creditos del Curso"));
                }
                while(numeroCreditos[i]==0);//Validar que el curso tenga por lo menos un credito
                do{
                    ciclo[i] = Integer.parseInt(JOptionPane.showInputDialog("Ingresar el ciclo al que pertenece el curso"));
                }
                while(ciclo[i]==0);//Validar que el curso pertenesca a un ciclo
                idPreRequisito[i] = JOptionPane.showInputDialog("Ingresar el ID de pre requisito. Si no tiene dejar en blanco.");
                if(idPreRequisito[i].isEmpty())
                    idPreRequisito[i]="No tiene pre-requisitos";                
                nt++;
                JOptionPane.showMessageDialog(null,"Se registraron los datos con exito. Ahora existen "+nt+"/"+capacidadCursos+" cursos registrados");                
            } 
        }  
        else{
            JOptionPane.showMessageDialog(null,"Ya no puede registrar mas datos. Existen "+nt+"/"+capacidadCursos+" cursos registrados.");      
        }
        return nt;
    }
    
    public static void modificarDatos(int capacidadCursos,String idCurso[],String nombreCurso[],int numeroCreditos[],int ciclo[],String idPreRequisito[]){
        ...
        if(posicionBusqueda == -1){
            ...
            JOptionPane.showMessageDialog(null,"Se ha encontrado el ID del curso ingresado. Aceptar para modificar los datos del curso.");
            do{
            ...
            do{
                numeroCreditos[posicionBusqueda] = Integer.parseInt(JOptionPane.showInputDialog("Ingresar la cantidad de creditos del Curso"));
            }
            while(numeroCreditos[posicionBusqueda]==0);
            do{
                ciclo[posicionBusqueda] = Integer.parseInt(JOptionPane.showInputDialog("Ingresar el ciclo al que pertenece el curso"));
            }
            while(ciclo[posicionBusqueda]==0);
            idPreRequisito[posicionBusqueda] = JOptionPane.showInputDialog("Ingresar el ID de pre requisito. Si no tiene dejar en blanco.");
    ...
    public static int eliminarDatos(int nt,String idCurso[],String nombreCurso[],int numeroCreditos[],int ciclo[],String idPreRequisito[]){
        int posicionBusqueda = -1;
    ...
    public static void consultarNombre(int nt,String idCurso[],String nombreCurso[],int numeroCreditos[],int ciclo[],String idPreRequisito[]){
        int posicionBusqueda = -1;
        ...
        if(posicionBusqueda == -1){
            ...
            JOptionPane.showMessageDialog(
                ...
                "Id Pre-requisitos: "+idPreRequisito[posicionBusqueda]
            );
        }
    }
    
    public static void consultarCiclo(int nt,String idCurso[],String nombreCurso[],int numeroCreditos[],int ciclo[],String idPreRequisito[]){
        int posicionBusqueda = -1;
        int cicloBusqueda = Integer.parseInt(JOptionPane.showInputDialog("Ingresar el Nombre del curso que desea buscar."));
        for(int i=0;i<nt;i++){
