...
public class Programa1 
{
    public static void main(String[]args)
    {
        ...
        Docente docente2 = new DocenteTiempoCompleto("Docente Tiempo Completo", "Henrry", "67890", "Administracion", 3000);
        ...
        Administrativo admin1 = new Administrativo("Administrativo", "Rolando", "45321", "Contabilidad", "Director", 2500);
